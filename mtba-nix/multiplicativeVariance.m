function v = multiplicativeVariance(x, resultSet, number, dimension)
% Preliminary measure of multiplicative coherence of a bicluster
%
...
if strcmp(dimension, both)
  ...
  if strcmp(dimension, 'row'), v = variance(div(A,2),2);  % Same as Matlab way
  elseif strcmp(dimension, 'col'), v = variance(div(A),1);
  end
end
end
